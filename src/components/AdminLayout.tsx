...
export default function AdminLayout({ children }: LayoutProps) {
  ...
  if (loading) return <div>Loading</div>; // Or loading indicator
  ...
  const navigation = [
    ...
    },
    {
      name: "Bounties",
      href: "/admin/bounties",
      current: router.pathname === "/admin/bounties",
    },
    {
      name: "Submissions",
      href: "/admin/subs",
      current: router.pathname === "/admin/subs",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-900">
        <Disclosure as="nav" className="border-b border-gray-800 bg-slate-900">
          {({ open }) => (
            <>
